...
function CheckBox(props) {
    ...
    const handleToggle = (value) => {            //넘어온 value는 props의 value로 Datas.js 의 regions의 id값이다. 해당 체크박스를 누르면 자기자신의 index와 value를 이용가능
        ...
        if (currentIndex === -1) {                       // 새로운 체크박스가 선택된다면 배열에 저장
